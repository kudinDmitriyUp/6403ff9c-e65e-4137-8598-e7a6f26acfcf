...
export const metadata: Metadata = {
  title: "Artemis Defense Fund - Legal Defense Support",
  description: "Providing comprehensive legal defense support for those facing unfair prosecution. Equal justice access for all.",
  keywords: "legal defense, justice, defense fund, fair representation",
  metadataBase: new URL("https://artemisdefense.org"),
  alternates: {
    canonical: "https://artemisdefense.org"
  },
  openGraph: {
    title: "Artemis Defense Fund",
    description: "Fighting for justice and equal legal rights for all.",
    siteName: "Artemis Defense Fund",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Artemis Defense Fund",
    description: "Providing comprehensive legal defense support"
  },
  robots: {
    index: true,
    follow: true
